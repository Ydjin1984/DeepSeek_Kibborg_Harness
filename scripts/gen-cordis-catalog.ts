...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  mcpServers: 'tools.md',
  openrouterFree: 'llm-streaming.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  skillManager: 'function-plugin-published Service class declared in packages/skill/skill-manager/src/manager.ts (not the loader entry default) — packages/skill/skill-manager/README.md owns the API',
  telegramBridge: 'optional host face (TelegramBridgeLike) declared absent-by-default so the gateway never depends on the bridge package; the Service class is TelegramBridgeService in packages/telegram/bridge/src/index.ts — packages/telegram/bridge/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  McpServerStatus: 'MCP registry status record is owned by packages/mcp/mcp-servers/README.md',
  RegistryServerEntry: 'MCP registry entry contract is owned by packages/mcp/mcp-servers/README.md',

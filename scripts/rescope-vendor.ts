...
const POSTCONDITIONS: readonly PostCondition[] = [
  ...
  { file: 'apps/cli/config/agent-presets/cordis/agent.cordis.yml', text: 'Пресет агента `cordis`', count: 1 },
  { file: 'apps/cli/config/agent-presets/cordis/agent.cordis.yml', text: 'пресета `cordis` отключило бы', count: 1 },

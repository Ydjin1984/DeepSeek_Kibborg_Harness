...
Source: [`packages/compaction/compaction-basic/src/types.ts:55`](../packages/compaction/compaction-basic/src/types.ts)
...
Source: [`packages/guard/engagement-stub/src/index.ts:21`](../packages/guard/engagement-stub/src/index.ts)
...
Source: [`packages/execution/execution-persistence/src/index.ts:37`](../packages/execution/execution-persistence/src/index.ts)
...
Source: [`packages/mcp/mcp-servers/src/index.ts:68`](../packages/mcp/mcp-servers/src/index.ts)
...
Source: [`packages/skill/skill-manager/src/manager.ts:114`](../packages/skill/skill-manager/src/manager.ts)
...
Source: [`packages/telegram/bridge/src/types.ts:9`](../packages/telegram/bridge/src/types.ts)
...
Source: [`packages/llm/typesafe-tool/src/index.ts:36`](../packages/llm/typesafe-tool/src/index.ts)
...
- `@deepseek-ai/dsh-orchestrator` — requires `skills` · `tools` · `subagents` · `systemPrompt` · `settings` ([`packages/context/orchestrator/src/index.ts`](../packages/context/orchestrator/src/index.ts))

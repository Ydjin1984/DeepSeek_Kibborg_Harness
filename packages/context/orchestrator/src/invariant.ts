/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-orchestrator`.
 * @module @deepseek-ai/dsh-orchestrator/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-orchestrator'

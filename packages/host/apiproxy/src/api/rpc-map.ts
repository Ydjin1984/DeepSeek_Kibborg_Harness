...
export interface RpcMethodMap {
  ...
  'host.listChildren': HostApi['listChildren']
  ...
  'skill.listManaged': SkillsApi['listManaged']
  'skill.read': SkillsApi['read']
  'skill.save': SkillsApi['save']
  'skill.remove': SkillsApi['remove']
  'skill.restore': SkillsApi['restore']
  'skill.permanentDelete': SkillsApi['permanentDelete']
  'skill.trash': SkillsApi['trash']
  'skill.setEnabled': SkillsApi['setEnabled']
  'skill.versions': SkillsApi['versions']
  'skill.rollback': SkillsApi['rollback']
  'skill.activate': SkillsApi['activate']
  'skill.validate': SkillsApi['validate']
  'skill.securityCheck': SkillsApi['securityCheck']
  'skill.benchmarkStart': SkillsApi['benchmarkStart']
  'skill.benchmarkPoll': SkillsApi['benchmarkPoll']
  'skill.benchmarkCancel': SkillsApi['benchmarkCancel']
  'skill.benchmarkBatchStart': SkillsApi['benchmarkBatchStart']
  'skill.autoImprove': SkillsApi['autoImprove']
  ...
  'llm.oauthLoginStart': LlmApi['oauthLoginStart']
  'llm.oauthLoginWait': LlmApi['oauthLoginWait']
  'llm.oauthLoginCancel': LlmApi['oauthLoginCancel']
  'llm.oauthLogout': LlmApi['oauthLogout']
}

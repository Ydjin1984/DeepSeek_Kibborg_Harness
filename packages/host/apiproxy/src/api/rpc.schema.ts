...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('file-outside-project'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-not-text'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('file-too-large'), message: z.string(), details: z.object({ path: z.string().optional() }) }),
  ...
  z.object({ code: z.literal('skill-manager-error'), message: z.string(), details: z.object({ code: z.string(), name: z.string().optional() }) }),

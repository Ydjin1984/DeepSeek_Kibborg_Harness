...
describe.skipIf(!hasPwsh)('persistent pwsh through a real cordis.yml Loader composition', () => {
  it('preserves cwd and environment across calls', async () => {
    // Canonical scratch root: the sandbox compares the session cwd textually,
    // so on macOS `/var/...` must be the `/private/var/...` realpath.
    ...
    console.log('[diag] loader observed=' + JSON.stringify(observed.slice(0, 2500)))

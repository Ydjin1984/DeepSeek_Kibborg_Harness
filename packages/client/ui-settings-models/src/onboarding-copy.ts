...
export const WELCOME_NOTICE_COPY = {
  ...
  ru: {
    ...
    body: 'DeepSeek Harness 0.1 всё ещё тестируется для разработчиков Harness. Многое предстоит доработать, и мы будем рады отзывам сообщества. Базовые плагины и API DeepSeek Harness продолжат быстро развиваться в ближайшие месяцы.\n\nМы приглашаем разработчиков по всему миру исследовать пределы интеллекта на открытой, повторно используемой и компонуемой инфраструктуре. Присоединяйтесь к экосистеме плагинов DSH.',

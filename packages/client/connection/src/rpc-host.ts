...
import { bridge, requestPeer, socketPeer, type FetchHandler } from './http-bridge.ts'
  ...
  createSharedFetchHandler(
    ...
    return {
      fetch: (request) => {
        ...
        if (interceptor.options.authority === 'loopback' && !isTrustedApiRequest(request, [], requestPeer(request))) {

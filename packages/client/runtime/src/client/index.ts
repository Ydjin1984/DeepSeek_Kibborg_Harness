...
export { indexSubagentDescendants, runningSubagentActivityRows, subagentActivityRows } from './sessions/subagent-lineage.ts'
export type { RunningSubagentActivityRow, SubagentActivityRow, SubagentDescendantSummary } from './sessions/subagent-lineage.ts'
...
export { createScope } from './contract/agent-scope.ts'
export type { AgentScopeHandle } from './contract/agent-scope.ts'

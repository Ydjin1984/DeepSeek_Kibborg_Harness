 ...
 * Agent's identity. Homed in contract because both the agents domain and the
 * sessions domain run it; agents/scope.ts re-exports for in-domain consumers.
 * The mechanism mirrors the host `dsh-scope` architecture

// Notifier: subscription + batched notification primitive shared by Session
// and SessionManager. Homed in contract because both the sessions and
// workspaces domains run it; sessions/notifier.ts re-exports for in-domain
// consumers. Semantics: N markDirty calls collapse into one microtask flush, while

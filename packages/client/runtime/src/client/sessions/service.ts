...
import type { SessionSearchResultItem } from '../contract/session-list.ts'
...
import type {
  SessionBinding, SessionListState, SessionProvideDescriptor, SessionSummary,
} from '../contract/session-list.ts'
...
// Scope primitives live in ../contract/agent-scope.ts (the client mirror of
// host dsh-scope, keyed by Agent identity); re-exported here so existing

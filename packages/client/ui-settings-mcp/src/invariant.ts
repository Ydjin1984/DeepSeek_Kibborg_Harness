...
/**
 * No runtime invariant: the section reads and writes the Host MCP registry
 * through the wire API only; it owns no cordis event or cross-plugin mutable
 * relation beyond the api calls it makes.
 */

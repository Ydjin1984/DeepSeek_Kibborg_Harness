...
import { CHAT_SEARCH_MAX_LINES, searchBlockLabels, type SearchCardModel } from '../models/search-card-model.ts'
...
export interface ToolRowProps {
  /** The render site's conversation locale seat (card-body copy). */

...
describe('invariant companion', () => {
  ...
  it('client apply provides ctx.locale seeded with the zh/en/ru common namespace', async () => {
    ...
    expect(() => (locale as LocaleRuntime).register(COMMON_NS, 'ru', {})).toThrow('already has locale')
  })
})

 ...
 * stream or mutable runtime data; the skill lifecycle facts it renders are owned by the
 * skill-manager service, whose own invariant companion checks the managed-files contract.
 */
